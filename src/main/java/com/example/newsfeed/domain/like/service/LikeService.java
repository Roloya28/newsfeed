...
public class LikeService {
    ...
    public String toggleLikeOnFeed(User user, Long feedId) {
        ...
        if (feed.getUser().equals(user)) {
            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "본인 게시물에는 좋아요를 할 수 없습니다.");
        }
    ...
    public String toggleLikeComment(User user, Long commentId) {
        ...
        if (comment.getUser().equals(user)) {
            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "본인 댓글에는 좋아요를 할 수 없습니다.");
        }
